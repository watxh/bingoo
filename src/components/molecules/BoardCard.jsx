...
const BoardCard = ({ data }) => {
  ...
  const SetLike = async (e) => {
    ...
    const a = await axios.patch(
      `https://bingoback.herokuapp.com/users/a/${data._id}`,
      params
    );
  };
    ...
    <Container>
      ...
      <UnderBox>
        ...
        <LikeBox>
          {press === 0 ? (
            <LikeImage
              src="/data/image/icon/Heart1.png"
              width="20"
              height="20"
              onClick={ChangeLike}
              press={press}
            ...
            <LikeImage
              src="/data/image/icon/Heart2.png"
              width="20"
              height="20"
              onClick={ChangeLike}
              press={press}
          ...
          <LikeText>
            {press === 1 ? SetComma(data.like + 1) : SetComma(data.like)}
          </LikeText>
        </LikeBox>
        <PlayBox>
          <PlayButton
            onClick={PlayGame}
            src="/data/image/icon/play.png"
          ></PlayButton>
        </PlayBox>
      </UnderBox>
    </Container>
