...
const Exmake2 = ({
  ...
  const Titlecolorclick = () => {
    if (titlecolorclick === 1) {
      setTitlecolorclick(0);
    } else {
      setTitlecolorclick(1);
    }
  };
  ...
  const Subtitlecolorclick = () => {
    if (subtitlecolorclick === 1) {
      setSubtitlecolorclick(0);
    } else {
      setSubtitlecolorclick(1);
    }
  };
    ...
    <All>
      <InfoBox>
        ...
        <InfoColorBox>
          ...
          {titlecolorclick ? (
            <Popover>
              <Cover onClick={Buttonclose}></Cover>
              <ChromePicker color={titlecolor} onChange={changetitlecolorh} />
            </Popover>
          ) : (
            <></>
          )}
        ...
        <InfoColorBox>
          <InfoColorPick
            backcolor={subtitlecolor}
            onClick={Subtitlecolorclick}
          />
          {subtitlecolorclick ? (
            <Popover>
              <Cover onClick={Buttonclose}></Cover>
        ...
        <TitleImageBox>
          ...
          {backcolorclick ? (
            <Popover>
              ...
              ></Cover>
              <ChromePicker color={backcolor} onChange={changebackcolorh} />
            </Popover>
          ) : (
            <></>
          )}
